...
knitr::opts_knit$set(root.dir = "~/Github/webmice")
```
...
### Primary WEBMICE end points
  ...
  | GET  | `/long`       | Impute missing data            | `complete(mice())`    
  |
...
file_path <- file.path("testdata", "tempdata.csv")
input <- curl::form_file(file_path, type = "text/csv")
...
##### **`/long`**: Impute data using the token 
...
#root_dir = "~\Github\webmice"
file_path = os.path.join("testdata", "tempdata.csv")
#file_path = r"...\testdata\tempdata.csv"

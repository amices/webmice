...
```{bash, eval=FALSE}
curl -X 'GET' \
  $(cat .host)/long?payload='%7B%22data%22%3A%22boys%22%2C%22maxit%22%3A2%2C%22m%22%3A2%2C%22seed%22%3A1%7D' \
...
##### **`/long`**: Impute data, return long form

```{r impute_r, eval=FALSE}
